...
import { PatternVisitorCallback, PatternVisitorOptions, Visitor } from '@typescript-eslint/experimental-utils/src/ts-eslint-scope/Options';
...
declare const PatternVisitor: {
    new (options: PatternVisitorOptions, rootPattern: any, callback: PatternVisitorCallback): PatternVisitor;
