...
import { ParserOptions as TSParserOptions } from '@typescript-eslint/experimental-utils/src/ts-eslint/ParserOptions';
import { RuleModule, RuleFix } from '@typescript-eslint/experimental-utils/src/ts-eslint/Rule';
import { Scope } from '@typescript-eslint/experimental-utils/src/ts-eslint/Scope';
import { SourceCode } from '@typescript-eslint/experimental-utils/src/ts-eslint/SourceCode';
interface Linter {
    version: string;
